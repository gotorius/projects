"""
PCam Dataset - PGD Attack + Guided-Diffusion (ImageNet Pretrained) Defense

ImageNet事前学習済み拡散モデルを用いた敵対的防御評価

実行例:
python imagenet_pgd_eval.py --epsilon 0.031 --start_t 80 --t_purify 50
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='PCam PGD Attack + Guided-Diffusion Defense')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/pcam/imagenet/pgd/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("PGD Attack + Guided-Diffusion (ImageNet) Defense Evaluation")
