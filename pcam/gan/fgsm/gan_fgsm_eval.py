"""
Defense-GAN Adversarial Defense Evaluation for PCam Dataset - FGSM Attack
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='Defense-GAN Evaluation - FGSM Attack')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/pcam/gan/fgsm/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("FGSM Attack + Defense-GAN Evaluation")
