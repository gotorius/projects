"""
DermMel - FGSM Attack + DDPM Defense Evaluation (Improved)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DermMel DDPM Defense Evaluation - FGSM Attack')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/dermmel/ddpm/fgsm/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("FGSM Attack + DDPM Defense Evaluation (DermMel)")
