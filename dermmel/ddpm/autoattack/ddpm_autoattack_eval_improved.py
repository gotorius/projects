"""
DermMel - AutoAttack + DDPM Defense Evaluation (Improved)
...
実行例:
python ddpm_autoattack_eval_improved.py --epsilon 0.031 --t_purify 50 --start_t 80
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DermMel DDPM Defense Evaluation - AutoAttack')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/dermmel/ddpm/autoattack/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("AutoAttack + DDPM Defense Evaluation (DermMel)")
