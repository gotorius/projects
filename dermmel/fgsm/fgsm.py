"""
DermMel (Melanoma分類) - FGSM攻撃 + DDPM防御検証スクリプト
...
# DDPMモデルのロード
ddpm_ckpt = "/mnt/data1/gotou/kaggle/dermmel/ddpm_out/ddpm_epoch100.pth"
...
# 評価ループ
for batch_idx, (images_norm, labels) in enumerate(tqdm(val_loader, desc="Evaluating")):
...
print("\n" + "="*70)
print("==== Results (DermMel - FGSM Attack + DDPM Defense) ====")
print("="*70)
...
with open(summary_path, 'w') as f:
    f.write("="*70 + "\n")
    f.write("DermMel - FGSM Attack + DDPM Defense Summary\n")
    f.write("="*70 + "\n\n")
