"""
DermMel - FGSM Attack + JPEG Compression Defense Evaluation

JPEG圧縮を使用した敵対的防御評価

実行例:
python jpeg_fgsm_eval.py --epsilon 0.031 --quality 11
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DermMel JPEG Defense Evaluation - FGSM Attack')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/dermmel/jpeg/fgsm/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("FGSM Attack + JPEG Compression Defense Evaluation (DermMel)")
