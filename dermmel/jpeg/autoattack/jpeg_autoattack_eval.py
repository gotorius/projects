"""
DermMel - AutoAttack + JPEG Compression Defense Evaluation

JPEG圧縮を使用した敵対的防御評価 (AutoAttack)

実行例:
python jpeg_autoattack_eval.py --epsilon 0.031 --quality 11
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DermMel JPEG Defense Evaluation - AutoAttack')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/dermmel/jpeg/autoattack/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("AutoAttack + JPEG Compression Defense Evaluation (DermMel)")
