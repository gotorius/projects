"""
PCam Dataset - AutoAttack + JPEG Compression Defense (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='PCam AutoAttack + JPEG Defense (ViT)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/pcam/jpeg/autoattack/results',
...
def main():
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("PCam - AutoAttack + JPEG Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
