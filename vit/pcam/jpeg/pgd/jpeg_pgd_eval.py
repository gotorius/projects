"""
PCam Dataset - PGD Attack + JPEG Compression Defense (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='PCam PGD Attack + JPEG Defense (ViT)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/pcam/jpeg/pgd/results',
...
def main():
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("PCam - PGD Attack + JPEG Compression Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
