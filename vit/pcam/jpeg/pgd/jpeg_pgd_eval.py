...
def parse_args():
    parser = argparse.ArgumentParser(description='PCam PGD + JPEG Defense (ViT)')
...
def main():
    ...
    print(f"\n{'='*70}")
    print("PCam - PGD + JPEG Defense (ViT)")
    print(f"{'='*70}")
    ...
    print(f"PGD: {results['adv_acc_no_defense']:.4f} | PGD+JPEG: {results['adv_acc_with_jpeg']:.4f}")
