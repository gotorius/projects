...
def main():
    ...
    print(f"\n{'='*70}")
    print("PCam - AutoAttack + Guided-Diffusion (ImageNet) Defense (ViT)")
    print(f"{'='*70}")
    ...
    print(f"\nClean: {results['clean_acc_classifier']:.4f} | Clean+Diffusion: {results['clean_acc_with_diffusion']:.4f}")
    print(f"AutoAttack: {results['adv_acc_no_defense']:.4f} | AutoAttack+Diffusion: {results['adv_acc_with_diffusion']:.4f}")
