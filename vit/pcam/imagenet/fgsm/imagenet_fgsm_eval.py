...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='PCam FGSM Attack + Guided-Diffusion Defense (ViT)')
...
def main():
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("PCam - FGSM Attack + Guided-Diffusion Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
