"""
PCam ViT用のバランスの取れたサンプルセットを作成
normal: 250枚、tumor: 250枚の合計500枚
ViT分類器で正しく分類された画像のみを使用

データセット: /mnt/data1/Public/MedImages/PCam_ImageFolder/test
分類器: /mnt/data1/gotou/projects/classifiers/vit/checkpoints/pcam/20260117_210505/best_vit_pcam.pth
"""
...
def main():
    ...
    clf_ckpt = '/mnt/data1/gotou/projects/classifiers/vit/checkpoints/pcam/20260117_210505/best_vit_pcam.pth'
    output_dir = '/mnt/data1/gotou/projects/pcam/vit'
