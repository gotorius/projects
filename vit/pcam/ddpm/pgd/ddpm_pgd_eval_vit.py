"""
DDPM-based Adversarial Defense Evaluation for PCam Dataset - PGD Attack (ViT Classifier)

ViT分類器を使用したDDPM防御評価スクリプト

実行例:
python ddpm_pgd_eval_vit.py --epsilon 0.031 --alpha 0.01 --steps 10
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DDPM Defense Evaluation - PGD Attack (ViT)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/pcam/vit/pgd/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("PGD Attack + DDPM Defense Evaluation (ViT Classifier)")
