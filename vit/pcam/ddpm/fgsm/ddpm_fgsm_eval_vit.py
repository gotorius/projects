"""
DDPM-based Adversarial Defense Evaluation for PCam Dataset - FGSM Attack (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DDPM Defense Evaluation - FGSM Attack (ViT)')
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("FGSM Attack + DDPM Defense Evaluation (ViT Classifier)")
