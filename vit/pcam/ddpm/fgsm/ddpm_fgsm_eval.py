"""
PCam Dataset - FGSM Attack + DDPM Purification Defense (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='PCam FGSM Attack + DDPM Defense (ViT)')
...
def main():
    ...
    # ==================== 評価開始 ====================
    print(f"\n{'='*70}")
    print("PCam - FGSM Attack + DDPM Defense Evaluation (ViT Classifier)")
    print(f"{'='*70}")
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("PCam - FGSM Attack + DDPM Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
