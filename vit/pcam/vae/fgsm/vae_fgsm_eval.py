"""
VAE (MagNet-style) FGSM Evaluation Script for PCam Dataset (ViT Classifier)
...
def parse_args():
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/pcam/vae/fgsm/results',
...
def main():
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("PCam - FGSM Attack + VAE Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
