"""
VAE (MagNet-style) FGSM Evaluation Script for ChestX-ray Dataset (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='VAE (MagNet) FGSM Evaluation (ViT)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/chestxray/vae/fgsm/results',
...
def main():
    ...
    # ==================== 評価開始 ====================
    print(f"\n{'='*70}")
    print("FGSM Attack + VAE Defense Evaluation (ViT Classifier)")
    print(f"{'='*70}")
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("ChestX-ray - FGSM Attack + VAE Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
