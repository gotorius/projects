"""
ChestX-ray Dataset - PGD Attack + JPEG Compression Defense (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='ChestX-ray PGD Attack + JPEG Defense (ViT)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/chestxray/jpeg/pgd/results',
...
def main():
    ...
    log_dir = os.path.join(args.output_dir, f"pgd_eps{args.epsilon:.4f}_steps{args.pgd_steps}_q{args.quality}_{timestamp}")
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("ChestX-ray - PGD Attack + JPEG Compression Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
