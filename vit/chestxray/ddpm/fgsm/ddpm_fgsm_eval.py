"""
ChestX-ray Dataset - FGSM Attack + DDPM Purification Defense (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='ChestX-ray FGSM Attack + DDPM Defense (ViT)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/chestxray/ddpm/fgsm/results',
...
def main():
    ...
    # ==================== 評価開始 ====================
    print(f"\n{'='*70}")
    print("FGSM Attack + DDPM Defense Evaluation (ViT Classifier)")
    print(f"{'='*70}")
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("ChestX-ray - FGSM Attack + DDPM Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
