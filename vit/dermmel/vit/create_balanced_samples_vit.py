"""
DermMel ViT用のバランスの取れたサンプルセットを作成
NotMelanoma: 250枚、Melanoma: 250枚の合計500枚
ViT分類器で正しく分類された画像のみを使用

データセット: /mnt/data1/Public/MedImages/DermMel/test
分類器: /mnt/data1/gotou/projects/classifiers/vit/checkpoints/dermmel/20260118_175806/best_vit_dermmel.pth
"""
...
def main():
    ...
    clf_ckpt = '/mnt/data1/gotou/projects/classifiers/vit/checkpoints/dermmel/20260118_175806/best_vit_dermmel.pth'
    output_dir = '/mnt/data1/gotou/projects/dermmel/vit'
