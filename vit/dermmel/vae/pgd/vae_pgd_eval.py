"""
DermMel Dataset - VAE (MagNet-style) PGD Evaluation (ViT Classifier)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='VAE (MagNet-style) + PGD Attack Evaluation for DermMel (ViT Classifier)',
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/dermmel/vae/pgd/results',
                        help='結果出力ディレクトリ')
