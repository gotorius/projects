"""
Defense-GAN Adversarial Defense Evaluation for DermMel Dataset (ViT Classifier) - FGSM Attack
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='Defense-GAN Evaluation for DermMel (ViT) - FGSM Attack')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/dermmel/gan/fgsm/results',
...
def main():
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("DermMel - FGSM Attack + Defense-GAN (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
