"""
DDPM-based Adversarial Defense Evaluation for DermMel Dataset - PGD Attack (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DDPM Defense Evaluation - PGD Attack (ViT) for DermMel')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/dermmel/ddpm/pgd/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("PGD Attack + DDPM Defense Evaluation (ViT Classifier) - DermMel")
