"""
DermMel Dataset - FGSM Attack + Guided-Diffusion (ImageNet Pretrained) Defense (ViT Classifier)
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DermMel FGSM Attack + Guided-Diffusion Defense (ViT)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/vit/dermmel/imagenet/fgsm/results',
...
def main():
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("DermMel - FGSM Attack + Guided-Diffusion Defense (ViT Classifier)\n")
        f.write("="*70 + "\n\n")
