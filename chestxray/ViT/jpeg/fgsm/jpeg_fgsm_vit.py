...
# ========== JPEG圧縮 (防御) ==========
def jpeg_compress_batch(x_pix, quality=11):
    """
...
out_dir = f'/mnt/data1/gotou/projects/chestxray/ViT/jpeg/fgsm/results_q{JPEG_QUALITY}'
...
print(f"\n======================================")
print("Starting FGSM + JPEG purification evaluation (ChestXray - ViT)")
...
if total == 0:
    ...
    print("\n======================================")
    print("Results (ChestXray ViT FGSM + JPEG)")
    print("======================================")
    ...
    with open(summary_txt, 'w') as f:
        f.write('=' * 70 + '\n')
        f.write('ChestXray ViT - FGSM + JPEG Purification Summary\n')
        f.write('=' * 70 + '\n\n')
