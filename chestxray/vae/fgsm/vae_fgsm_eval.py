"""
VAE (MagNet-style) FGSM Evaluation Script for ChestX-ray Dataset
...
実行例:
python vae_fgsm_eval.py --vae_ckpt ../checkpoints/best_model.pth --gpu 0
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='VAE (MagNet) FGSM Evaluation')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/chestxray/vae/fgsm/results',
...
def main():
    ...
    print(f"\n{'='*70}")
    print("FGSM Attack + VAE (MagNet) Defense Evaluation")
    print(f"{'='*70}")
