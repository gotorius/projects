"""
JPEG Compression-based Adversarial Defense Evaluation for PCam Dataset - FGSM Attack

JPEG圧縮を用いた敵対的攻撃への防御評価

実行例:
python jpeg_fgsm_eval.py --epsilon 0.031 --jpeg_quality 11
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='JPEG Defense Evaluation - FGSM Attack')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/pcam/jpeg/fgsm/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("FGSM Attack + JPEG Defense Evaluation")
