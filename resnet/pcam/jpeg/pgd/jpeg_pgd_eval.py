"""
JPEG Compression-based Adversarial Defense Evaluation for PCam Dataset - PGD Attack

JPEG圧縮を用いた敵対的攻撃への防御評価

実行例:
python jpeg_pgd_eval.py --epsilon 0.031 --alpha 0.01 --steps 10 --jpeg_quality 11
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='JPEG Defense Evaluation - PGD Attack')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/pcam/jpeg/pgd/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("PGD Attack + JPEG Defense Evaluation")
