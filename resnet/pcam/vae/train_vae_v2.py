"""
VAE (MagNet-style) Training Script for PCam (PatchCamelyon) Dataset - Version 2
...
Version 2 の変更点:
============================================================
- latent_dim: 256 → 512 (より表現力のある潜在空間)
- base_ch: 48 → 64 (モデル容量の増加)
- lr: 2e-4 → 1e-4 (より安定した学習)
- beta_max: 0.1 → 0.01 (再構成品質重視)
- lambda_perceptual: 1.0 → 2.0
- lambda_ssim: 1.0 → 2.0
- lambda_adv: 0.05 → 0.02
- 新規: Edge Loss (エッジ保存のための損失)
- 新規: use_amp オプション (AMP使用可否)

============================================================
実行例:
============================================================
python train_vae_v2.py --epochs 300 --batch_size 8 --gpu 0
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='Train VAE v2 for PCam')
