"""
PCam Dataset - FGSM Attack + Guided-Diffusion (ImageNet Pretrained) Defense
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='PCam FGSM Attack + Guided-Diffusion Defense')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/pcam/imagenet/fgsm/results',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("FGSM Attack + Guided-Diffusion (ImageNet) Defense Evaluation")
