"""
Defense-GAN: PCam (PatchCamelyon) データセット用 訓練コード (修正版v3)
...
# ========== 設定 ==========
def get_args():
    parser = argparse.ArgumentParser(description='Defense-GAN Training for PCam (v3)')
    parser.add_argument('--data_dir', type=str,
                        default='/mnt/data1/Public/MedImages/PCam_ImageFolder/train',
                        help='訓練データのパス')
    parser.add_argument('--save_dir', type=str,
                        default='/mnt/data1/gotou/projects/pcam/gan/checkpoints_v3',
                        help='モデル保存先')
