"""
DDPM-based Adversarial Defense Evaluation for PCam Dataset - AutoAttack (Improved)
...
実行例:
python ddpm_autoattack_eval_improved.py --epsilon 0.031 --version standard
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='DDPM Defense Evaluation - AutoAttack (Improved)')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/pcam/ddpm/autoattack/results_improved',
...
def main():
    ...
    write_and_print(f"\n{'='*70}")
    write_and_print("AutoAttack + DDPM Defense Evaluation (Improved)")
