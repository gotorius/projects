"""
ChestX-ray Dataset - FGSM Attack + DDPM Purification Defense
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='ChestX-ray FGSM Attack + DDPM Defense')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/chestxray/ddpm/fgsm/results',
...
def main():
    ...
    with open(summary_path, 'w') as f:
        f.write("="*70 + "\n")
        f.write("ChestX-ray - FGSM Attack + DDPM Defense\n")
        f.write("="*70 + "\n\n")
