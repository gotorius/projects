"""
Defense-GAN PGD Evaluation Script for ChestX-ray Dataset
...
実行例:
python gan_pgd_eval.py --gan_ckpt ../checkpoints/best_model.pth --gpu 0
"""
...
# ========== 引数パーサー ==========
def parse_args():
    parser = argparse.ArgumentParser(description='Defense-GAN PGD Evaluation')
...
def main():
    ...
    print(f"\n{'='*70}")
    print("PGD Attack + Defense-GAN Evaluation")
    print(f"{'='*70}")
