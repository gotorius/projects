"""
Defense-GAN Adversarial Defense Evaluation for ChestX-ray - PGD Attack (v2 Improved)
...
実行例:
python gan_pgd_eval_v2.py --epsilon 0.031 --use_defense
python gan_pgd_eval_v2.py --epsilon 0.031 --pgd_steps 20 --pgd_alpha 0.007
python gan_pgd_eval_v2.py --epsilon 0.031 --rec_iters 200 --rec_rr 5
"""
...
# ========== 引数 ==========
def parse_args():
    parser = argparse.ArgumentParser(description='Defense-GAN PGD Evaluation v2')
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/mnt/data1/gotou/projects/chestxray/gan/pgd/results')
...
def main():
    ...
    log(f"\n{'='*70}")
    log("PGD Attack + Defense-GAN v2 Evaluation")
    log(f"{'='*70}")
