...
FGSM版と同一フォーマットで統計/CSV/トリプレットを出力
"""
import os
import io
import torch
...
out_dir = f'/mnt/data1/gotou/projects/chestxray/jpeg/pgd/results_q{JPEG_QUALITY}_pgd{PGD_STEPS}_a{int(PGD_ALPHA*255)}'
...
print(f"\n======================================")
print("Starting PGD + JPEG purification evaluation (ChestXray)")
...
if total == 0:
    ...
    print("\n======================================")
    print("Results (ChestXray PGD + JPEG)")
    print("======================================")
    ...
    with open(summary_txt, 'w') as f:
        f.write('=' * 70 + '\n')
        f.write('ChestXray - PGD + JPEG Purification Summary\n')
        f.write('=' * 70 + '\n\n')
